...
const projects = reactive([
  ...
  },
  {
    ...
    CnDocLink:
      "https://medium.com/@gwennie.io/%E5%BE%AE%E7%BB%84%E4%BB%B6%E5%8A%A0%E8%BD%BD%E5%99%A8%E5%8E%9F%E7%90%86%E4%B8%8E%E4%BB%A3%E7%A0%81%E5%AE%9E%E7%8E%B0-c4cee176e0e8",
  ...
  },
  {
    ...
    EnDocLink:
      "https://medium.com/@gwennie.io/send-you-a-bingdwendwen-drawn-with-css-acc063dc7558",
  },
]);
...
const consoleOutput = () => {
  ...
  if (wrapperDomScrollHeight > wrapperDomHeight * 1.5) {
    //设置阈值为1.5一屏半
    ...
    <div class="open-source-pro-box">
      <div class="projects-wrap">
        ...
        >
          ...
          <div v-if="item.githubLink">
            github地址：<a :href="item.githubLink" target="_blank">{{
              item.githubLink
            }}</a>
          </div>
          <div v-if="item.CnDocLink">
            中文说明文档：<a :href="item.CnDocLink" target="_blank">{{
              item.CnTitle
            }}</a>
          </div>
          <div v-if="item.EnDocLink">
            英文说明文档：<a :href="item.EnDocLink" target="_blank">{{
              item.EnTitle
            }}</a>
          </div>
        </div>
